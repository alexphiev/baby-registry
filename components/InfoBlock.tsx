      ...
      <div className="rounded-xl border border-(--color-border) bg-white overflow-hidden">
        ...
        >
          ...
          <Link
            ...
            className="shrink-0 inline-flex items-center justify-center rounded-lg px-5 h-9 text-[14px] font-semibold text-white transition-opacity hover:opacity-80"
